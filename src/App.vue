...
<template>
  ...
  >
    ...
    <footer v-if="!isAdminRoute" class="mt-14 border-t border-clay-100/70 bg-[#f7f7f7]">
      <div class="mx-auto max-w-6xl px-4 py-10">
        <div class="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div class="space-y-4 text-sm text-clay-800">
            ...
            <RouterLink class="block rounded py-1 hover:text-clay-950" to="/rooms">
              {{ t('nav.rooms') }}
            </RouterLink>
            <RouterLink class="block rounded py-1 hover:text-clay-950" to="/restaurants">
              {{ t('nav.restaurants') }}
            </RouterLink>
            <RouterLink class="block rounded py-1 hover:text-clay-950" to="/services">
              {{ t('nav.services') }}
            </RouterLink>
            <RouterLink class="block rounded py-1 hover:text-clay-950" :to="{ path: '/', hash: '#contact' }">
              {{ t('nav.contacts') }}
            </RouterLink>
          </div>
          ...
          <div class="space-y-4 text-sm text-clay-800">
            ...
            <p class="text-xs text-clay-700">
              ...
              <a class="font-semibold text-clay-800" href="mailto:zafaronpremiumhotel@gmail.com">
                zafaronpremiumhotel@gmail.com
              </a>
            </p>
            <RouterLink
